...
import SOSLogo from '../../images2/SOS_Logo_removebg.png'; // Add this line to import your image
...

    {
      adminRole &&
        allLinks.push({
          ...
          text: 'Emergency & Insurance Maintenance',
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        ...
        >
          <img src={SOSLogo} alt="SOS Logo" className="w-11 h-11" /> FMS
        </NavLink>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {filteredLinks?.map((e, i) => (
                <li key={e.id}>
                  <NavLink
                    to={e.path}
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes(e.styleChecker) &&
                      'bg-graydark dark:bg-meta-4'
                      }`}
                  >
                    {e.icon} {e.text}
