                            ...
                            {adminRole && (
                              <td className="border-b py-2">
                                <div className="flex items-center justify-center space-x-3.5">
                                  ...
                                  >
                                    <span className="m-1 btn h-[30px] min-h-[30px] text-sm dark:text-white dark:bg-slate-700 dark:border-slate-700 dark:hover:bg-opacity-70 transition duration-150 ease-in-out rounded-md">
