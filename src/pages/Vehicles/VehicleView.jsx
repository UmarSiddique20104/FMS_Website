            ...
            <div className="flex p-5 bg-brand-primary">
              <div className="flex flex-col gap-1 w-4/5">
                <div className="grid grid-cols-2 gap-1">
                  ...
                  <div>
                    <p className="text-md font-semibold">Chasis No.:</p>
                    <p className="text-md mb-5 font-normal">
                      {data?.data?.chasisNo}
                    </p>
                  </div>
                  <div>
                    <p className="text-md font-semibold">Engine No.:</p>
                    <p className="text-md mb-5 font-normal">
                      {data?.data?.engineNo}
                    </p>
                  </div>
                  <div>
                    ...
                    <p
                      className={`text-md mb-5 font-normal ${!data?.data?.fule_card_apl ? 'text-danger' : ''}`}
                    >
                      {data?.data?.fule_card_apl ?? 'Not Available'}
                    </p>
                  </div>

                  <div>
                    <p className="text-md font-semibold">POS Card No.:</p>
                    <p
                      className={`text-md mb-5 font-normal ${!data?.data?.fule_card_pos ? 'text-danger' : ''}`}
                    >
                      {data?.data?.fule_card_pos ?? 'Not Available'}
                    </p>
                  </div>

                  <div>
                    <p className="text-md font-semibold">Emergency Card No.:</p>
                    <p
                      className={`text-md mb-5 font-normal ${!data?.data?.emergency_maintenance_card ? 'text-danger' : ''}`}
                    >
                      {data?.data?.emergency_maintenance_card ??
                        'Not Available'}
                    </p>
                  </div>
                  ...
                  <div>
                    <p className="text-md font-semibold">Insured: </p>
                    <p className="text-md mb-5 font-normal">
                      {data?.data?.isInsured ? 'Yes' : 'No'}
                    </p>
                  </div>
                  ...
                  {data?.data?.isInsured && (
                    <>
                      <div>
                        <p className="text-md font-semibold">Insurance Start Date: </p>
                        <p className="text-md mb-5 font-normal">
                          {data?.data?.insuranceStartDate}
                        </p>
                      </div>
                      <div>
                        <p className="text-md font-semibold">Insurance End Date: </p>
                        <p className="text-md mb-5 font-normal">
                          {data?.data?.insuranceEndDate}
                        </p>
                      </div>
                    </>
                  )}
