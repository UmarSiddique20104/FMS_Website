...
const FuelRequestForm = () => {
  ...
  const [currentMeterReadingManually, setcurrentMeterReadingManually] =
    useState(true);
  ...
  useEffect(() => {
    if (formValues.modeOfFueling === 'PSO') {
      if (vehicleDetails?.data?.fule_card_pos) {
        setFormValues({
          ...formValues,
          cardNo: vehicleDetails?.data?.fule_card_pos,
        });
      } else {
        setFormValues({
          ...formValues,
    ...
    } else if (formValues.modeOfFueling === 'APL') {
      if (vehicleDetails?.data?.fule_card_apl) {
        setFormValues({
          ...formValues,
          cardNo: vehicleDetails?.data?.fule_card_apl,
        });
      } else {
        setFormValues({
          ...formValues,
    ...
    } else if (formValues.modeOfFueling === 'EMERGENCY CARD') {
      if (vehicleDetails?.data?.emergency_maintenance_card) {
        setFormValues({
          ...formValues,
          cardNo: vehicleDetails?.data?.emergency_maintenance_card,
        });
      } else {
        setFormValues({
          ...formValues,
                    ...
                    <div className="mt-2">
                      <label className="inline-flex items-center mr-6">
                        <input
                          ...
                          onChange={() => {
                            setcurrentMeterReadingManually(false);
                            setIsOdometerMalfunctioned(true);
                          }}
                      ...
                      <label className="inline-flex items-center">
                        <input
                          ...
                          checked={!isOdometerMalfunctioned}
                          onChange={() => {
                            setcurrentMeterReadingManually(true);
                            setIsOdometerMalfunctioned(false);
                          }}
                          className="form-radio"
                        />
