...
const UpdateFuelRequestForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const formData = {
      ...
      distance:
        ...
        fuelData?.data?.previousOddometerReading,
    };
    try {
  ...
  useEffect(() => {
    if (fuelData && fuelData.data) {
      ...
      if(fuelData.data.currentOddometerReading){
              ...
              <div className="p-7">
                ...
                {showPreviousRecordError ? (
                  <div className="mt-8 text-red-500">
                    Error: <b>"Current Odometer (Manually)"</b> is less than
                    <b>"Previous Odometer Reading"</b>. Please check the
                    odometer readings.
                  </div>
                ) : (
                  <div className="mt-8">
