...
import { useGetDriverQuery } from '../../services/driverSlice';
                      ...
                      <dialog id="cnic_modal" className="modal justify-center">
                        <div className="modal-box   max-w-[700px]">
                          <form method="dialog">
                            ...
                            <button className="btn btn-sm btn-circle bg-[#422AFB] text-white btn-ghost absolute right-2 top-2">
                              ✕
                            </button>
                          </form>
                  ...
                  <div>
                    ...
                    <p className="text-md mb-5 font-normal">
                      ...
                      >
                        <div className="modal-box   max-w-[700px]">
                          <form method="dialog">
                            <button className="btn btn-sm btn-circle btn-ghost bg-[#422AFB] text-white  absolute right-2 top-2">
                              ✕
                            </button>
                          </form>
