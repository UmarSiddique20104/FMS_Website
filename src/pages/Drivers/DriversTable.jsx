...
const DriversTable = ({ searchTerm, setSortedDataIndex }) => {
  ...
  if (isError) return <div>Error occurred while fetching drivers.</div>;
  if (!sortedData?.length)
    return (
      <div>
        <center>
          <h4 className="font-semibold">No Drivers Found!</h4>
        </center>
      </div>
    );
  return (
